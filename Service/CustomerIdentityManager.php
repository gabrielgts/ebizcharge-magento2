...
/**
 * Resolves the three EBizCharge customer identifiers without controlling payment action.
 *
 * CustomerId is supplied by Magento. CustomerInternalId and CustNum are generated by EBizCharge.
 */
class CustomerIdentityManager
{
    ...
    /**
     * Best-effort checkout resolution. Failures never replace Magento's configured payment action
     * or prevent the transaction request from carrying its deterministic CustomerID.
     *
    ...
    /**
     * Looks up an existing remote identity without creating or persisting anything.
     */
    ...
    /**
     * Resolves or creates the remote customer and atomically persists all identifiers.
     *
     * @param array<string,mixed> $customerData
     */
    ...
    private function resolveRemote(
        ...
        try {
            // CustomerId is the ERP-facing canonical key. Do not send a cached internal ID here:
            // GetCustomer prioritizes it and a stale value could resolve the wrong customer.
    ...
    /**
     * @param array<string,string> $securityToken
